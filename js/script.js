...
if(document.getElementById("pedido"+String(pedido))!==null){
...
function alterarNome(){
	if(innerWidth<=650){
		document.getElementById("nomeEmpresa").innerHTML = "Beco"
	}else{
		document.getElementById("nomeEmpresa").innerHTML = "Beco Hamburgueria"
	}
}
